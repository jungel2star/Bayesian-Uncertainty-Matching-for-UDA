...
@register_dataset('webcam')
class Webcam(DatasetGroup):
    ...
    def __init__(self, path=None, shuffle=True):
        DatasetGroup.__init__(self, 'webcam', path=path)
        self.image_shape = (256, 256, 3)
        self.label_shape = ()
        self.shuffle = shuffle
        self._load_datasets()
    def _load_datasets(self):
        dataset,label=pickle.load(open("./data/office31/webcam_256.pkl","rb"))
        ...
        dataset_validation_10, label_validation_10 = pickle.load(open("./data/office31/webcam_10.pkl", "rb"))
