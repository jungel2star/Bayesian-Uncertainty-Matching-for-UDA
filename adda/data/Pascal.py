...
@register_dataset('Pascal')
class Pascal(DatasetGroup):
    ...
    def __init__(self, path=None, shuffle=True):
        DatasetGroup.__init__(self, 'Pascal', path=path)
        self.image_shape = (224, 224, 3)
        self.label_shape = ()
        self.shuffle = shuffle
        self._load_datasets()
    def _load_datasets(self):
        dataset,label=pickle.load(open("./data/image_CLEF/Pascal.pkl","rb"))
