...
@register_model_fn('VGG16_original')
def VGG16_original(inputs, scope='VGG16_original',class_number=65, is_training=True, reuse=False,batch_size=128,dropout_ratio=1.0):
    layers = OrderedDict()
    net = inputs
...
VGG16_original.default_image_size = 224  # fully convolutional
VGG16_original.num_channels = 3
VGG16_original.mean = np.array([123.68, 116.779, 103.939], dtype=np.float32)
VGG16_original.bgr = False
